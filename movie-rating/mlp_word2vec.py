...
from dataTrans import getWholeFeatureVecs, getSentimentVecs

def test_mlp(learning_rate=0.01, L1_reg=0.00, L2_reg=0.008, n_epochs=1000,num_features = 300,dim=1,
min_word_count=40,trainset='train_labeled_review.tsv',testset='testData.tsv', batch_size=50, n_hidden=500):
    """ 
...
#    print "Training Word2Vec model..."
    ...
    model_name = "%d features_40minwords_10context" %num_features
